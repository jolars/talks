...
\subtitle{A Summary of My Thesis}
...
\begin{frame}[c]
  ...
  \begin{block}{Basic Insight}
    \begin{itemize}
      % TODO: Add an illustration of this, preferably a heatmap of when coefficients are zero
...
\begin{frame}[c]
  \begin{figure}[htpb]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/paper1-cor-coef-lasso-path.pdf}
    \caption{%
...
\begin{frame}
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.45\textwidth}
      \centering
      % TODO: X axis label is incorrect, fix it!
      \includegraphics[width=\textwidth]{figures/paper3-lasso-path.pdf}
      NEED TO FIX X AXIS LABEL
    \end{column}
  \end{columns}
...
\begin{frame}[c]
    ...
    \begin{column}{0.7\textwidth}
      \begin{block}{LibSLOPE}
        \begin{itemize}
          ...
          \item Natively parallelized routines for fitting paths and cross-validation
  ...
  \begin{block}{Packages}
    \begin{description}[SLOPE]
      \item[R] SLOPE: \url{https://jolars.github.io/slope/}
      \item[Python] sortedl1: \url{https://jolars.github.io/sortedl1/}
      \item[C++] libslope: \url{https://jolars.github.io/sortedl1/}
    \end{description}
  \end{block}
...
\begin{frame}[c]
  \begin{figure}[htpb]
    ...
    \caption{%
      The motivation: normalization matters. Lasso paths under two different types of normalization (standardization and max--abs normalization). The union of the first ten features selected in any of the settings are colored.
    }
  \end{figure}
